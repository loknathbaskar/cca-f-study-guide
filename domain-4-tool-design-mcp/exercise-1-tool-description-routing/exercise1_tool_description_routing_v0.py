...
TEST_QUERIES = [
    ...
    ("Show me all orders placed by customer #12345", "get_customer_orders",
     "scoped to ONE customer — should NOT be search_orders"),
    ("Find all orders across the store with status 'delayed'", "search_orders",
     "system-wide filter, not tied to one customer — should NOT be get_customer_orders"),

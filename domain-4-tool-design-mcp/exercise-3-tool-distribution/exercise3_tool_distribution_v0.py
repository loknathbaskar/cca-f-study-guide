...
TEST_QUERIES = [
    ...
    ("I need to submit a PTO request for next Friday", "request_pto"),
    ("My laptop was stolen, I need to report it", "report_device_lost"),
    # The two deliberately ambiguous, cross-domain-colliding queries:
    ("I need to update my payment information", "update_payment_method"),  # e-commerce sense
    ("I need to update where my paycheck gets deposited", "update_direct_deposit"),  # HR sense, but shares "payment/deposit" semantics
    ("I'm locked out of my account, can you unlock it?", "unlock_account"),
]
...
def run_monolithic():
    ...
    for query, expected in TEST_QUERIES:
        ...
        called = tool_call.name if tool_call else "NO TOOL"
